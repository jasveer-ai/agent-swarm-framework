...
from agent_swarm.core.config import AgentProfile, BudgetConfig, Pricing, ProviderConfig
from agent_swarm.core.run import InvocationRecord, RunRecord
...
class UsageLedger:
    ...
    def summary(self) -> Dict[str, object]:
        ...
        return {
            ...
            "budget_overage_reason": self.overage_reason(),
